...
# Function to load NIfTI Methodology1_Scans with labels
...
# Load GM and FA Methodology1_Scans with matching indices
...
np.save(start_path + r"/Interim/features.npy", all_features)
...
labels_path = start_path + r"/Interim/labels.npy"
